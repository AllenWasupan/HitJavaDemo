...
INSERT INTO `attribute_value` (`id`, `attribute_id`, `value`) VALUES 
  (1, 1, 'WHITE'), (2, 1, 'RED'), (3, 1, 'BLUE'), (4, 1, 'GREEN'),
  (5, 2, 'S'), (6, 2, 'M'), (7, 2, 'XL'), (8, 2, 'OSF')
...
CREATE TABLE IF NOT EXISTS `product_attribute` (
  ...
  CONSTRAINT `FK_product_attribute_attribute` FOREIGN KEY (`attribute_id`) REFERENCES `attribute` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `product_attribute` (`id`, `product_id`, `sku_id`, `attribute_id`, `attribute_value_id`,`position`) VALUES 
  (1, 1, 1, 1, 1), -- White color
  (2, 1, 2, 1, 3), -- Blue color
  (3, 1, 1, 2, 5), -- Size S
  (4, 1, 2, 2, 6); -- Size M
